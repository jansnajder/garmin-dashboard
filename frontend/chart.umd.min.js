...
!(function (t, e) {
  ...
  class bt {
    ...
    _getAnims(t) {
      ...
      let i = e.get(t);
      return (
        i || ((i = { running: !1, initial: !0, items: [], listeners: { complete: [], progress: [] } }), e.set(t, i)),
        i
      );
    }
    listen(t, e, i) {
  ...
  class Js extends Hs {
    ...
    _getXAxisLabelAlignment() {
      ...
      let i = 'center';
      return (
        'start' === e.align ? (i = 'left') : 'end' === e.align ? (i = 'right') : 'inner' === e.align && (i = 'inner'),
        i
      );
    }
  ...
  function go(t, e, i, s) {
    ...
    if (-1 === n)
      return ((t, e, i, s) => (
        'string' == typeof e ? ((i = t.push(e) - 1), s.unshift({ index: i, label: e })) : isNaN(e) && (i = null),
        i
      ))(t, e, i, s);
