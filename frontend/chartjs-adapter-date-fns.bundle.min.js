...
!(function (t, e) {
      ...
      match: {
        ordinalNumber:
          ...
          function (t, e) {
            ...
            return { value: (u = n.valueCallback ? n.valueCallback(u) : u), rest: r.slice(i.length) };
          }),
        era: S({
          matchPatterns: {
            narrow: /^(b|a)/i,
  ...
  var A = 'midnight',
    ...
    V = {
      ...
      Y: function (t, e, r, n) {
        var a = X(t, n),
          i = a > 0 ? a : 1 - a;
        return 'YY' === e ? E(i % 100, 2) : 'Yo' === e ? r.ordinalNumber(i, { unit: 'year' }) : E(i, e.length);
      },
      R: function (t, e) {
      ...
      w: function (t, e, r, n) {
        var a = z(t, n);
        return 'wo' === e ? r.ordinalNumber(a, { unit: 'week' }) : E(a, e.length);
      },
      I: function (t, e, r) {
        var n = I(t);
        return 'Io' === e ? r.ordinalNumber(n, { unit: 'week' }) : E(n, e.length);
      },
      d: function (t, e, r) {
        return 'do' === e ? r.ordinalNumber(t.getUTCDate(), { unit: 'date' }) : O.d(t, e);
      },
      D: function (t, e, a) {
        var i = (function (t) {
          r(1, arguments);
        ...
        return 'Do' === e ? a.ordinalNumber(i, { unit: 'dayOfYear' }) : E(i, e.length);
      },
      E: function (t, e, r) {
        var n = t.getUTCDay();
        switch (e) {
      ...
      H: function (t, e, r) {
        return 'Ho' === e ? r.ordinalNumber(t.getUTCHours(), { unit: 'hour' }) : O.H(t, e);
      },
      K: function (t, e, r) {
        var n = t.getUTCHours() % 12;
        return 'Ko' === e ? r.ordinalNumber(n, { unit: 'hour' }) : E(n, e.length);
      },
      k: function (t, e, r) {
        var n = t.getUTCHours();
        return (0 === n && (n = 24), 'ko' === e ? r.ordinalNumber(n, { unit: 'hour' }) : E(n, e.length));
      },
      m: function (t, e, r) {
        return 'mo' === e ? r.ordinalNumber(t.getUTCMinutes(), { unit: 'minute' }) : O.m(t, e);
      },
      s: function (t, e, r) {
        return 'so' === e ? r.ordinalNumber(t.getUTCSeconds(), { unit: 'second' }) : O.s(t, e);
      },
      S: function (t, e) {
        return O.S(t, e);
      },
      ...
      i: {
        ...
        parse: function (t, e, r, n) {
          ...
          switch (e) {
            ...
            case 'iii':
              return (
                r.day(t, { width: 'abbreviated', context: 'formatting', valueCallback: a }) ||
                r.day(t, { width: 'short', context: 'formatting', valueCallback: a }) ||
                r.day(t, { width: 'narrow', context: 'formatting', valueCallback: a })
              );
            case 'iiiii':
            ...
            default:
              return (
                r.day(t, { width: 'wide', context: 'formatting', valueCallback: a }) ||
                r.day(t, { width: 'abbreviated', context: 'formatting', valueCallback: a }) ||
                r.day(t, { width: 'short', context: 'formatting', valueCallback: a }) ||
                r.day(t, { width: 'narrow', context: 'formatting', valueCallback: a })
              );
  ...
  var le = 36e5,
    fe = { dateTimeDelimiter: /[T ]/, timeZoneDelimiter: /[Z ]/i, timezone: /([Z+-].*)$/ },
      ...
      (/:/.test(n[0])
        ...
        : ((r.date = n[0]),
          ...
          fe.timeZoneDelimiter.test(r.date) &&
            ((r.date = t.split(fe.timeZoneDelimiter)[0]), (e = t.substr(r.date.length, t.length)))),
      e)
    ) {
  ...
  function ve(t, e) {
    ...
    var a = n[1] && parseInt(n[1]),
      i = n[2] && parseInt(n[2]);
    return { year: null == i ? a : 100 * i, restDateString: t.slice((n[1] || n[2]).length) };
  }
  function ye(t, e) {
  ...
  t._adapters._date.override({
            ...
            (t =
              'string' == typeof a
                ? (function (t, a, i, o) {
                    ...
                    var y,
                      b = { firstWeekContainsDate: m, weekStartsOn: v, locale: l },
                      T = [{ priority: 10, subPriority: -1, set: ce, index: 0 }],
                      p = s
                        .match(ae)
                        .map(function (t) {
                          var e = t[0];
                    ...
                    for (y = 0; y < p.length; y++) {
                      ...
                      if (x) {
                        ...
                        if (Array.isArray(k)) {
                          ...
                          throw new RangeError(
                            "The format string mustn't contain `".concat(M, '` and any other token at the same time'),
                          );
    ...
    format: function (t, a) {
      return (function (t, a, i) {
        ...
        var y = c(v),
          b = H(v, y),
          T = { firstWeekContainsDate: f, weekStartsOn: g, locale: s, _originalDate: v },
          p = o
            .match(mt)
            .map(function (t) {
              var e = t[0];
